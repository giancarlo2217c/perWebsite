...
function Projects() {
    ...
    return (
        <div id = "projects" className = {styles.projectsSection}>
            ...
            <Project link = "https://github.com/fujirinngo/ECS165A-LStore" direc = "gs_reveal_fromLeft" imgSrc = {database} title = "Lstore Database System" desc = {projectOneDesc} />
            <Project link = "https://freeeduseg.gianlambert.repl.co/" direc = "gs_reveal_fromRight" imgSrc = {freeEdu} title = "Education Is Free" desc = {projectTwoDesc} />
            <Project direc = "gs_reveal_fromLeft" imgSrc = {macbookdesk} title = "My Coding Journey" desc = {projectThreeDesc} />
            <Project link = "https://github.com/giancarlo2217c/ML_AI" direc = "gs_reveal_fromRight" imgSrc = {ml} title = "Bayes Algorithm Classifier" desc = {projectFourDesc} />
        </div>
    )
}
